...
void saveAllSettingsToEEPROM()
{
  ...
  for (int i = 0; i < scheduleCount; i++)
  {
    ...
    Serial.print("Saved onHours[");
    Serial.print(i);
    Serial.print("]: ");
    Serial.println(onHours[i]);
    addr += sizeof(int);

    EEPROM.put(addr, onMinutes[i]);
    Serial.print("Saved onMinutes[");
    Serial.print(i);
    Serial.print("]: ");
    ...
    Serial.print("Saved offHours[");
    Serial.print(i);
    Serial.print("]: ");
    Serial.println(offHours[i]);
    addr += sizeof(int);

    EEPROM.put(addr, offMinutes[i]);
    Serial.print("Saved offMinutes[");
    Serial.print(i);
    Serial.print("]: ");
...
void loadAllSettingsFromEEPROM()
{
  ...
  for (int i = 0; i < scheduleCount; i++)
  {
    ...
    Serial.print("Loaded offMinutes[");
    Serial.print(i);
    Serial.print("]: ");
    Serial.println(offMinutes[i]);
    addr += sizeof(int);
  ...
  Serial.println("All settings loaded from EEPROM");
  Serial.println("-----------------------------");
}
